...
def merge_images(video_name, video_length, gt_base_dir):
    ...
    folder = os.path.join('merge_images/hdnerv2', video_name)
...
if __name__ == "__main__":
    ...
    gt_base_dir = 'logs/UVG/HDNeRV2/ConvNeXt_2_256x320_fc_4_5_Dims192,192,192,192,160_Blocks3,3,9,3,3_exp2_f8_k3_e1600_warm320_b2_lr0.0005_Fusion6_Strd4,2,2,2,2_eval/visualize'
    NUM_THREADS = 4
